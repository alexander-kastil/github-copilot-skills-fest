...
3. The webapi will use Entity Framework and SQL Lite for the database. The SQLite database monafit-db will be in root of the project. Include it in the csproj file
6. Scaffold the fontened in src/monafit-ui the directory using the Angular CLI 19.2 and Node 20.12.2.
