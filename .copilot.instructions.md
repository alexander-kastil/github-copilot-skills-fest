...
Create all classes in the root namespace. Sub-Namespaces are not allowed.
...
For each controller create a corresponding test file CONTROLLER.http using the RESTClient Extension and add a sample request for each method.
